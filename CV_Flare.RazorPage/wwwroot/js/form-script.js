...
$(document).ready(function(){
    ...
    */
    ...
    $('.add-hoppies').on('click',function(){
        $('.all-hoppies').append('<div class="add-border"><span></span><h2>New Hoppy</h2><span></span></div><div class="new-hoppies"> <label>Sở thích 1</label> <input type="text" name="socials[]" class="form-control"> <label>Hoppy icon image (32px*32px)</label><input type="file" name="hoppies[]" class="form-control" /></div>');
