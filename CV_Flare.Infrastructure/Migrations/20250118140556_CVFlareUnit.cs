...
{
    /// <inheritdoc />
    public partial class CVFlareUnit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AspUId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    UserCreateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserUpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AspNetUsers_AspUId",
                        column: x => x.AspUId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CvSubmissions", x => x.SubmissionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CvSubmissions_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "PackageId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CvSubmissions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserTemplatesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    TemplateId = table.Column<int>(type: "int", nullable: false),
                    ...
                    TemplateProgress = table.Column<int>(type: "int", nullable: true),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTemplates", x => x.UserTemplatesId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CvEdits", x => x.EditId);
                    table.ForeignKey(
                        name: "FK_CvEdits_CvSubmissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "CvSubmissions",
                        principalColumn: "SubmissionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CvEdits_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CvEdits_SubmissionId",
                table: "CvEdits",
                column: "SubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_CvEdits_UserId",
                table: "CvEdits",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CvSubmissions_PackageId",
                table: "CvSubmissions",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_CvSubmissions_UserId",
                table: "CvSubmissions",
                column: "UserId");
